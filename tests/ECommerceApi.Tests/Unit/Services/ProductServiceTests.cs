...
private ProductService CreateService() =>
    new(_productRepository.Object, _categoryRepository.Object);
...
public async Task CreateProduct_WithNegativePrice_ThrowsValidation()
{
    ...
    var act = () => service.CreateProductAsync(
...
[Fact]
public async Task CreateProduct_WithCategoryId_VerifiesCategoryExists()
{
...
[Fact]
public async Task CreateProduct_WithMissingCategory_ThrowsNotFound()
{
    var categoryId = Guid.NewGuid();
...
[Fact]
public async Task UpdateProduct_WithValidFields_Succeeds()
{
    var id = Guid.NewGuid();
    var updatedProduct = MakeProduct(id);

    _productRepository
        .Setup(r => r.UpdateAsync(
            id,
            It.IsAny<Action<Product>>()))
        .Callback<Guid, Action<Product>>((_, updateAction) =>
        {
            updateAction(updatedProduct);
        })
...
[Fact]
public async Task UpdateProduct_WhenRepositoryReturnsNull_ThrowsNullReferenceException()
{
    var id = Guid.NewGuid();
    ...
    var act = () => service.UpdateProductAsync(
        id,
        new UpdateProductRequest
        {
            Name = "Updated Widget",
...
[Fact]
public async Task UpdateProduct_WithNegativePrice_ThrowsValidation()
{
    var id = Guid.NewGuid();
...
[Fact]
public async Task UpdateProduct_WithNegativeStock_ThrowsValidation()
{
    var id = Guid.NewGuid();
...
[Fact]
public async Task UpdateProduct_WithCategoryId_VerifiesCategoryExists()
{
    var id = Guid.NewGuid();
    var categoryId = Guid.NewGuid();
...
[Fact]
public async Task UpdateProduct_WithMissingCategory_ThrowsNotFound()
{
    var id = Guid.NewGuid();
    var categoryId = Guid.NewGuid();
...
public async Task DeactivateProduct_SoftDeletesRatherThanHardDeleting()
{
    ...
    _productRepository
        ...
        .ReturnsAsync(MakeProduct(id, isDeleted: true));
